...
class BasePage:
    ...
    def getElement(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("Unable to find element with locator Type: " + locatorType + "and with locator value: " + locatorValue)
    ...
    def clickElement(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            element = self.waitForElement(locatorValue, locatorType)
            element.click()
            self.log.info("Clicked on element found with locator Type: "+locatorType +" and with locator value: "+locatorValue)
        except:
            self.log.info("Unable to click element with locator Type: " + locatorType + " and with locator value: " + locatorValue)
    ...
    def isDisplayed(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("Element with locator Type: "+locatorType +" and with locator value: "+locatorValue + " is displayed.")
            return True
        except:
