...
ele3 = wait.until(lambda x: x.find_element_by_android_uiautomator('new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text("Insight Connectivity"))'))

actions = TouchAction(driver)
actions.long_press(ele3, 294, 80, 5)
actions.perform()
